  ...
  if (arrayProducto === null){
    ...
    arrayProducto.forEach(element => {
      ...
      <td class="cantidad-producto">
        ...
        <span type="submit" class=" mr-1 text-success"><i class="fa fa-minus" aria-hidden="true"></i></span>

          <input class="cart_quantity_input" type="text" name="quantity" value="1" autocomplete="off" size="1">
          
          <span type="submit" class="ml-1 text-success"><i class="fa fa-plus" aria-hidden="true"></i></span>
        </div>
      </td>
      <td>
        <p>120.00</p>
